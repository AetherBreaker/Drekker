...
if TYPE_CHECKING:
  ...
  # First party imports
  from drekker.logging import logging_config
...
def init_logging(*queues: QueueCatchall) -> None:
  ...
  try:
    ...
    # First party imports
    from drekker.logging.logging_config import configure_logging_main
...
def init_logging_worker(queue: QueueCatchall) -> None:
  ...
  try:
    ...
    # First party imports
    from drekker.logging.logging_config import configure_logging_worker
